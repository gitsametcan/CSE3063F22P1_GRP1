...
public class ObjectCreator {
	...
	private void newLecture(String ID, String lectureName, LectureType lectureType, int credits, Lecture prerequisite,
			int quota) {
		...
		LectureSession lectureSession = new LectureSession(tempSessionID, lecture, randomizeSessionHours(), null, null,
				null);
